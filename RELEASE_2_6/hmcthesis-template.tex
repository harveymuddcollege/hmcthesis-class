...
%%% Here we're using the plainnat bibliography style, which is
%%% defined in a file called plainnat.bst somewhere in one of the
%%% TEXMF trees on your system.

\bibliographystyle{plainnat}

%%% plainnat is meant for use with the natbib bibliography and
%%% citation package, which we highly recommend.
